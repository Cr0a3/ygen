...
pub(crate) fn x64_lower_salloc(sink: &mut Vec<X64RegAllocInstr>, instr: &MachineInstr) {
    ...
    sink.extend_from_slice(&[
        X64RegAllocInstr::with2(Mnemonic::Lea, RegAllocOperand::Tmp0, RegAllocOperand::Allocated(Operand::Mem(X64Reg::Rbp - offset as u32))),
...
pub(crate) fn x64_lower_load(sink: &mut Vec<X64RegAllocInstr>, instr: &MachineInstr) {
    ...
    sink.extend_from_slice(&[
        X64RegAllocInstr::with2(Mnemonic::Mov, RegAllocOperand::Tmp0, ptr),
        X64RegAllocInstr::with2(Mnemonic::Mov, out, RegAllocOperand::Tmp0),
    ]);
